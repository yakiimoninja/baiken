...
pub async fn info_to_json(mut char_info_response_json: String, mut file: &File, char_count: usize){
    ...
    let processed_char_info = serde_json::to_string_pretty(&CharInfo {
        defense: char_info.defense.get_or_insert_with(|| String::from("-")).to_string(),
        guts: char_info.guts.get_or_insert_with(|| String::from("-")).to_string(),
        guard_balance: char_info.guard_balance.get_or_insert_with(|| String::from("-")).to_string(),
        prejump: char_info.prejump.get_or_insert_with(|| String::from("-")).to_string(),
        umo: _umo_processed_string,
        forward_dash: char_info.forward_dash.get_or_insert_with(|| String::from("-")).to_string(),
        backdash: char_info.backdash.get_or_insert_with(|| String::from("-")).to_string(),
        backdash_duration: char_info.backdash_duration.get_or_insert_with(|| String::from("-")).to_string(),
        backdash_invincibility: char_info.backdash_invincibility.get_or_insert_with(|| String::from("-")).to_string(),
        backdash_airborne: char_info.backdash_airborne.get_or_insert_with(|| String::from("-")).to_string(),
        backdash_distance: char_info.backdash_distance.get_or_insert_with(|| String::from("-")).to_string(),
        jump_duration: char_info.jump_duration.get_or_insert_with(|| String::from("-")).to_string(),
        jump_height: char_info.jump_height.get_or_insert_with(|| String::from("-")).to_string(),
        high_jump_duration: char_info.high_jump_duration.get_or_insert_with(|| String::from("-")).to_string(),
        high_jump_height: char_info.high_jump_height.get_or_insert_with(|| String::from("-")).to_string(),
        earliest_iad: char_info.earliest_iad.get_or_insert_with(|| String::from("-")).to_string(),
        ad_duration: char_info.ad_duration.get_or_insert_with(|| String::from("-")).to_string(),
        ad_distance: char_info.ad_distance.get_or_insert_with(|| String::from("-")).to_string(),
        abd_duration: char_info.abd_duration.get_or_insert_with(|| String::from("-")).to_string(),
        abd_distance: char_info.abd_distance.get_or_insert_with(|| String::from("-")).to_string(),
        movement_tension: char_info.movement_tension.get_or_insert_with(|| String::from("-")).to_string(),
        jump_tension: char_info.jump_tension.get_or_insert_with(|| String::from("-")).to_string(),
        airdash_tension: char_info.airdash_tension.get_or_insert_with(|| String::from("-")).to_string(),
        walk_speed: char_info.walk_speed.get_or_insert_with(|| String::from("-")).to_string(),
        back_walk_speed: char_info.back_walk_speed.get_or_insert_with(|| String::from("-")).to_string(),
        dash_initial_speed: char_info.dash_initial_speed.get_or_insert_with(|| String::from("-")).to_string(),
        dash_acceleration: char_info.dash_acceleration.get_or_insert_with(|| String::from("-")).to_string(),
        dash_friction: char_info.dash_friction.get_or_insert_with(|| String::from("-")).to_string(),
        jump_gravity: char_info.jump_gravity.get_or_insert_with(|| String::from("-")).to_string(),
        high_jump_gravity: char_info.high_jump_gravity.get_or_insert_with(|| String::from("-")).to_string(),
    }).unwrap();
